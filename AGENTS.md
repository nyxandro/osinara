...
корневому ходу: запланированный запуск и дочерний агент сами в чат ничего не доставляют и маркера не
знают. Отбивка перед вызовом инструмента, содержащая маркер, отбрасывается, как и реакция.
